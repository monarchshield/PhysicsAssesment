...
Skybox::Skybox()
{
	images.push_back("./Resources/Skybox/Desert/right.jpg");
	images.push_back("./Resources/Skybox/Desert/left.jpg");
	images.push_back("./Resources/Skybox/Desert/top.jpg");
	images.push_back("./Resources/Skybox/Desert/bottom.jpg");

	images.push_back("./Resources/Skybox/Desert/front.jpg");
	images.push_back("./Resources/Skybox/Desert/back.jpg");
